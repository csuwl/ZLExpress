 ...
 * dds = now();
 * dds recentDay 3;
 * "2024-12-12" recentDay 3;
 *
 * @author wagnlei
 */
public class RecentDayVis implements ICustomVisitor {
    ...
    public Result visit(ParseTree tree, VisitProcess visitProcess) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ZLExpressParser.RecentDayExpressionContext ctx = (ZLExpressParser.RecentDayExpressionContext) tree;
    ...
    public Class<? extends ParseTree> getProcessType() {
        return ZLExpressParser.RecentDayExpressionContext.class;
    }
}
